...
class DocumentoIntegrationTest {
    ...
    void setup() {
        ...
        Usuario u = usuarioRepository.save(new Usuario(null,"Carol","carol@example.com","pass",""));
        usuarioId = u.getId();
    }

    @Test
    void documentoIntegration_deveRetornar200() throws Exception {
        ...
        mvc.perform(multipart("/api/usuarios/" + usuarioId + "/documentos")
                        .file(doc)
                        .file(face)
    ...
    @Test
    void documentoIntegration_deveRetornar422_quandoTipoInvalido() throws Exception {
        MockMultipartFile doc = new MockMultipartFile(
                "documento", "doc.pdf",
                MediaType.APPLICATION_PDF_VALUE,
                new byte[]{0x01}
